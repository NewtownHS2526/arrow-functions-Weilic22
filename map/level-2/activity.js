...
// Your solution here (one-line arrow function):
const exercise2Result1 = exercise2Array.map(num => `${num} dollars`)
...
// Your solution here (one-line arrow function):
const exercise3Result1 = exercise3Array.map(word => `<div>${word}</div>`)

// Your solution here (regular arrow function):
const exercise3Result2 = exercise3Array.map((word) => {
  return `<div>${word}"</div>`
})
...
// Your solution here (one-line arrow function):
const exercise4Result1 = exercise4Array.map(num => (num*num) + 10)

// Your solution here (regular arrow function):
const exercise4Result2 = exercise4Array.map((num) => {
  return (num*num) + 10
})
...
// Your solution here (one-line arrow function):
const exercise5Result1 = exercise5Array.map(word => word.split("").reverse().join(""))

// Your solution here (regular arrow function):
const exercise5Result2 = exercise5Array.map((word) => {
