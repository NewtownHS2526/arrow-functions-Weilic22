...
// Your solution here (one-line arrow function):
const exercise2Result1 = exercise2Array.reduce((acc,fruit) => (acc[fruit] = fruit.length, acc), {})
// Your solution here (regular arrow function):
const exercise2Result2 = exercise2Array.reduce((acc,fruit) => {
  return acc[fruit] = fruit.length , acc
}, {})
...
// Your solution here (one-line arrow function):
const exercise3Result1 = exercise3Array.reduce((acc,n) => (acc + n))/(exercise3Array.length)

// Your solution here (regular arrow function):
const exercise3Result2 = exercise3Array.reduce((acc,n) => {
  return (acc+n)
})/(exercise3Array.length)
...
// Your solution here (one-line arrow function):
const exercise4Result1 = exercise4Array.reduce((acc,current) => current.score > acc.score ? current : acc)
// Your solution here (regular arrow function):
const exercise4Result2 = exercise4Array.reduce((acc,current) => {
...
// Your solution here (one-line arrow function):
// NOT DONE BECAUSE OF DIFFICULTY

// Your solution here (regular arrow function):
const exercise5Result2 = exercise5Array.reduce((acc,num) => {
  if (num % 2 ===0) {
    acc.even.push(num)
  } else {
    acc.odd.push(num)
