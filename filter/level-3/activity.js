...
// Your solution here (one-line arrow function):
const exercise2Result1 = exercise2Array.filter(people => people.city === "New York")

// Your solution here (regular arrow function):
const exercise2Result2 = exercise2Array.filter((people) => {
  return people.city === "New York"
})
